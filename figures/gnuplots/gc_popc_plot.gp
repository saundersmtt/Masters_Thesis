...
set output paper_dir.'gouy_POPC_potential.eps'
...
popc_dir.'Potential/average_electric_potential.dat' u (($1-9.750000)):($6*1000):($7*1000) every 13 w err ls 2 title "Potential from Sim",\
popc_dir.'Potential/average_electric_potential.dat' u (-($1-9.750000)):($6*1000):($7*1000) every 13 w err ls 2 notitle
...
popc_dir.'GC_Stuff/test_Na_Dens.dat' u 1:2:3 every 8 w err ls 3 title "Na^+ Sim",\
popc_dir.'GC_Stuff/test_Cl_Dens.dat' u 1:2:3 every 8 w err ls 4 title "Cl^- Sim"
